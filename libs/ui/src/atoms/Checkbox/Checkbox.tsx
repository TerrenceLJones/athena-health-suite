...
export function Checkbox({
  ...
  return (
    <RadixCheckbox.Root
      ...
      className={[
        'focus-visible:ring-accent box-border inline-flex items-center justify-center rounded outline-none focus-visible:ring-3',
        on
          ? 'bg-accent border-accent border-[1.5px]'
          : 'border-border-strong bg-surface border-[1.5px]',
